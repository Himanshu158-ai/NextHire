    ...
    <div className="min-h-screen bg-[#fafafc] font-sans selection:bg-pink-200 flex flex-col overflow-x-hidden relative">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-12 py-5 bg-white/70 backdrop-blur-lg border-b border-slate-100">
        ...
        <Link to="/login" className="text-sm font-semibold text-slate-500 hover:text-slate-700 transition-colors">
          ...
          <span className="text-pink-500 hover:text-pink-600 font-bold ml-1">Sign In</span>
        </Link>
      </nav>
          ...
          <div className="bg-white rounded-[2rem] border border-slate-100 shadow-[0_20px_60px_-20px_rgba(244,114,182,0.15)] px-8 py-10">
            ...
            <form className="space-y-5" onSubmit={send}>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 p-1.5 bg-[#fafafc] border border-slate-200 rounded-2xl">
                  <button
                    type="button"
